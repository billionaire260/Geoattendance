...
public class Geofencepage extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMapLongClickListener {
                ...
                .addOnSuccessListener(this, new OnSuccessListener<Location>() {
                    ...
                    public void onSuccess(Location location) {
                        ...
                        if (location != null) {
                            ...
                            mMap.setOnMapLongClickListener(Geofencepage.this);
                            ///new here
                            if (Build.VERSION.SDK_INT >= 30) {

                                if (ContextCompat.checkSelfPermission(Geofencepage.this, Manifest.permission.ACCESS_BACKGROUND_LOCATION)
                                    ...
                                    if (ActivityCompat.shouldShowRequestPermissionRationale(Geofencepage.this, Manifest.permission
                                            .ACCESS_BACKGROUND_LOCATION)) {
                                        ActivityCompat.requestPermissions(Geofencepage.this, new String[]{Manifest.permission
    ...
    public void sharefence()
    {
        FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
        Mods mods = new Mods(String.valueOf(lat),String.valueOf(lon),"radious");
        FirebaseAuth firebaseAuth = FirebaseAuth.getInstance();
        DatabaseReference mydb = firebaseDatabase.getReference();
        mydb.child("new").child(firebaseAuth.getCurrentUser().getUid()).setValue(mods);
        Toast.makeText(getApplicationContext(),"Shaairing completed",Toast.LENGTH_SHORT).show();
        startActivity(new Intent(Geofencepage.this,Hrmenu.class));
        finish();
    }
